...
import page from "../../../assets/U1 WB/imgs/Right G1- Activity Book_page-0039.jpg";
import arrowBtn from "../../../assets/unit1/imgs/Page 01/Arrow.svg";
import "./WB_Unit7_Page1.css";

const WB_Unit7_Page1= ({ openPopup }) => {
  return (
    <div
