...
import page from "../../../assets/U1 WB/imgs/Right G1- Activity Book_page-0044.jpg";
import arrowBtn from "../../../assets/unit1/imgs/Page 01/Arrow.svg";
import "./WB_Unit7_Page6.css";

const WB_Unit7_Page6= ({ openPopup }) => {
  return (
    <div
...
<div
        className="wb-unit7-p6-q3 hover:scale-110 transition"
        style={{ overflow: "visible" }}
      >
        <svg
          width="22"
