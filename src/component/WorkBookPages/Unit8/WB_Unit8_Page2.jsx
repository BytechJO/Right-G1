...
import page from "../../../assets/U1 WB/imgs/Right G1- Activity Book_page-0046.jpg";
import arrowBtn from "../../../assets/unit1/imgs/Page 01/Arrow.svg";
import "./WB_Unit8_Page2.css";

const WB_Unit8_Page2= ({ openPopup }) => {
  return (
    <div
