...
const WB_Unit8_Page3_Q2 = () => {
  ...
  const items = [
    {
      img: img1,
      options: ["Close my eyes.", "Open your mouth."],
      correctIndex: 1,
    },
    {
      img: img2,
      options: ["Touch your head.", "Touch my nose."],
      correctIndex: 0,
    },
    {
      img: img3,
      options: ["Raise your hand.", "Bend my knee."],
      correctIndex: 1,
    },
    {
      img: img4,
      options: ["Bend my knee.", "Touch my nose."],
      correctIndex: 1,
    },
  ];
...
export default WB_Unit8_Page3_Q2;
