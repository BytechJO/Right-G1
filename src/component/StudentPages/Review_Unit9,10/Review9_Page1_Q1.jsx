...
const Review9_Page1_Q1 = () => {
  ...
  const items = [
    { img: img1, options: ["horse", "chicken"], correctIndex: 1 },
    { img: img2, options: ["cow", "goat"], correctIndex: 0 },
    { img: img3, options: ["dog", "horse"], correctIndex: 1 },
    { img: img4, options: ["dog", "goat"], correctIndex: 1 },
  ];
